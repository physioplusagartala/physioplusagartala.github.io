...
const teamMembers = [
  {
    ...
    image: "/images/dr-birat-banik.jpg",
  ...
  },
  {
    ...
    image: "/images/dr-parijat-saha.jpg",
    role: "Senior Physiotherapist",
    experience: "6 Years of Experience",
...
const OurTeam = () => {
  const jsonLd = {
    ...
    "@graph": teamMembers.map((m) => ({
      ...
      name: m.name,
      jobTitle: m.role,
      image: `https://physioplusagartala.com${m.image}`,
      url: "https://physioplusagartala.com",
      worksFor: { "@type": "Organization", name: "Physio Plus Agartala" },
    })),
  };
  ...
  return (
    <Layout>
            ...
            {teamMembers.map((member) => (
              ...
              >
                <CardContent className="p-0">
                  {/* Photo - optimized for mobile, SEO, and performance */}
                  {member.image && (
                    <img
                      src={member.image}
                      alt={`${member.name} - ${member.role} at Physio Plus Agartala`}
                      className="w-full aspect-square sm:aspect-video md:aspect-square object-cover"
                      loading="lazy"
                      decoding="async"
                    />
                  )}
      ...
      {/* JSON-LD for Physicians (generated from teamMembers) */}
      <script
