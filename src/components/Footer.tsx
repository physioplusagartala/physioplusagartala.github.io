  ...
  <footer className="border-t border-border bg-foreground text-background">
    <div className="mx-auto max-w-6xl px-4 py-12 md:py-16">
      <div className="grid gap-8 md:grid-cols-4">
        ...
        {/* Quick Links */}
        <div>
          <h4 className="font-heading text-sm font-semibold mb-4 uppercase tracking-wider opacity-60">
            Quick Links
          </h4>
        ...
        <div>
          ...
          <div className="flex flex-col gap-3 text-sm opacity-70">
            ...
            <div className="flex items-center gap-2">
              ...
              <a href="tel:+916033497168" className="hover:opacity-100">
                +91 60334 97168
              </a>
            </div>
            <div className="flex items-center gap-2">
        ...
        <div>
          ...
          <div className="flex flex-col gap-2 text-sm opacity-70">
            <div className="flex items-center gap-2">
              ...
              <span>Monday to Saturday: 1:00 PM – 8:30 PM</span>
            </div>
      ...
      <div className="mt-10 flex flex-col items-center justify-between gap-4 border-t border-background/20 pt-8 md:flex-row">
        <p className="text-xs opacity-50">
          © {new Date().getFullYear()} Physio Plus Agartala. All rights
          reserved.
        </p>
